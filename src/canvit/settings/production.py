...
if os.environ.get('PROD'):
    ...
    AWS_STORAGE_BUCKET_NAME = 'django-sample-bucket'
    ...
    STATICFILES_STORAGE = 'sample.aws.utils.StaticRootS3BotoStorage'

    STATICFILES_DIRS = (
        '%s/main-static' % BASE_DIR,
    )

    DEFAULT_FILE_STORAGE = 'sample.aws.utils.MediaRootS3BotoStorage'
